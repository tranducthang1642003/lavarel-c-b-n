                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-xl-3">
                                <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                    <label for="fruits">phân loại</label>
                                    <select id="fruits" name="fruitlist" class="border-0 form-select-sm bg-light me-3" form="fruitform">
                                        <option value="volvo">mặc định</option>
                                        <option value="saab">dâu</option>
                                        <option value="opel">chuối</option>
                                        <option value="audi">củ</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>bắp</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
...
@endforeach
                                        <div class="d-flex align-items-center justify-content-start">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex mb-2">
                                                    <h5 class="fw-bold me-2">60.000 đ</h5>
                                                    <h5 class="text-danger text-decoration-line-through">4.11 $</h5>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute" style="top: 50%; right: 10px; transform: translateY(-50%);">
                                                <h3 class="text-secondary fw-bold">trái <br> cây rất <br> là tươi</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">500.000 đ/ kg</p>
