            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">100% thức ăn tự nhiên</h4>
                        <h1 class="mb-5 display-3 text-primary">Thực phẩm rau và trái cây hữu cơ</h1>
                    ...
                    <div class="col-md-12 col-lg-5">
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <img src="{{ asset('././img/hero-img-1.png') }}" alt="Image">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a>
                                </div>
                                <div class="carousel-item rounded">
                                <img src="{{ asset('././img/hero-img-2.jpg') }}" alt="Image">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                <h5>Free Ship</h5>
                                <p class="mb-0">Miễn phí cho đơn hàng trên 300.000<span>đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>nho</h4>
                                                    <p>Nho Xanh Úc không hạt phổ biến là: Thompson, Pristine, Autumn King quả dài thuân, màu xanh hổ phách, vị ngọt mát, rất giòn và đặc biệt là không có hạt</p>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Oranges</h4>
                                                    <p>Nho Xanh Úc không hạt phổ biến là: Thompson, Pristine, Autumn King quả dài thuân…</p>
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                    </div>
